    ...
    <div className={styles.container}>
      ...
      <div className={styles.room1}>
        <button onClick={() => handleRoomButtonClick('Room1')}>
          <div className={styles.room}>Java</div>
          <div className={styles.desc}>5 active</div>
        </button>

        <button onClick={() => handleRoomButtonClick('Room2')}>
          <div className={styles.room}>DBMS</div>
          <div className={styles.desc}>14 active</div>
        </button>

        <button onClick={() => handleRoomButtonClick('Room3')}>
          <div className={styles.room}>Networks</div>
          <div className={styles.desc}>9 active</div>
        </button>
      </div>
    </div>
  );
